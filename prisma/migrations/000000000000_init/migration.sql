...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('MENTION', 'REPLY', 'REACTION', 'INVITE', 'DM', 'SYSTEM');
...
-- CreateIndex
CREATE INDEX "Channel_workspaceId_isArchived_idx" ON "Channel"("workspaceId", "isArchived");
...
-- CreateIndex
CREATE UNIQUE INDEX "ReadState_channelId_userId_key" ON "ReadState"("channelId", "userId");

-- CreateIndex
CREATE INDEX "ConversationMember_userId_idx" ON "ConversationMember"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "ConversationMember_channelId_userId_key" ON "ConversationMember"("channelId", "userId");
