...
export default function RegisterPage() {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    // Auto sign-in, then let the user verify their email from the banner.
    ...
    return (
      ...
      >
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          ...
          <span className="font-medium text-foreground">{pendingEmail}</span>. You can explore
          right away — some actions unlock after verifying.
        </p>
